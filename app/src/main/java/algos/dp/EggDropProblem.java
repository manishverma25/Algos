...
public class EggDropProblem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" BBBB  drops required  with eggs:" +
                " " + eggs + " and floors:" + floors + " is: " + eggDropRecursion.eggDroppingUsingDp(floors, eggs));
    }
    ...
    int eggDropWithRecursion(int eggs, int floors) {
        ...
        for (int i = 1; i <= floors; i++) {
            ...
            int egg_break = eggDropWithRecursion(eggs - 1, i - 1);
            ...
            int egg_not_break = eggDropWithRecursion(eggs, floors - i);
    ...
    int eggDroppingUsingDp(int floors, int eggs) {
